...
const homepageTestimonialsManual = [
  {
    ...
    avatar: "/banqueimage/EB2E6717-CA48-4A36-964F-F87046E7E8B3_1_105_c.jpeg",
  },
  {
    ...
    avatar: "/banqueimage/FBA85ADD-220C-4264-9DB2-F6ADB00BA672_1_105_c.jpeg",
  },
  {
    ...
    avatar: "/banqueimage/B2CD846F-197B-4DE8-8451-FDF12972EAF0_1_105_c.jpeg",
  },
  {
    ...
    avatar: "/banqueimage/7F1687EA-728A-4C4C-ADD2-FE7E87FFF6A9_1_105_c.jpeg",
  },
  {
  ...
  },
  {
    ...
    avatar: "/banqueimage/92DA1783-7A2B-4052-A487-40BCC9E39FF2_1_105_c.jpeg",
  },
];

const blogArticles = [
  {
    image: "/banqueimage/blog/blog-surf-prep-01.jpg",
    category: "Surf",
  ...
  {
    image: "/banqueimage/gallery/gallery-activity-cooking-01.jpg",
  ...
  {
    image: "/banqueimage/blog/blog-surf-board-01.jpg",
    category: "Famille",
...
const galeriePhotos = [
  "/banqueimage/FBA85ADD-220C-4264-9DB2-F6ADB00BA672_1_105_c.jpeg",
  "/banqueimage/1A463BBF-4EAD-43C2-903F-654F290BD7CB_4_5005_c.jpeg",
  "/banqueimage/D2C51D85-3B07-4604-8D68-D3695FED5451_1_105_c.jpeg",
  "/banqueimage/3780DBFE-A033-4775-937D-685CAAD87197_1_105_c.jpeg",
  "/banqueimage/B2CD846F-197B-4DE8-8451-FDF12972EAF0_1_105_c.jpeg",
  "/banqueimage/7F1687EA-728A-4C4C-ADD2-FE7E87FFF6A9_1_105_c.jpeg",
];

const streamMosaicImages = [
  "/banqueimage/testimonials/testimonial-portrait-smile-01.jpg",
  "/banqueimage/gallery/gallery-workshop-01.jpg",
  "/banqueimage/activity/activity-surf-session-02.jpg",
  "/banqueimage/gallery/gallery-camp-evening-01.jpg",
  "/banqueimage/ambient/ambient-ocean-glow-01.jpg",
  "/banqueimage/group/group-team-beach-01.jpg",
];
          ...
          <Reveal delay={0.04}>
            ...
            >
              ...
              <div className="bento-photo" style={{ gridColumn: "1", gridRow: "1 / 3", borderRadius: 14, overflow: "hidden", position: "relative" }}>
                <Image
                  src="/banqueimage/PXL_20250727_104701460.PORTRAIT.jpg"
              ...
              <div className="bento-photo" style={{ gridColumn: "2", gridRow: "2", borderRadius: 14, overflow: "hidden", position: "relative" }}>
                <Image
                  src="/banqueimage/gallery/gallery-activity-cooking-01.jpg"
            ...
            <div className="flex flex-col gap-3 md:hidden">
              <div className="bento-photo relative h-[220px] overflow-hidden rounded-[14px]">
                <Image src="/banqueimage/PXL_20250727_104701460.PORTRAIT.jpg" alt="ColoCrew" fill className="object-cover" sizes="100vw" />
                <div style={{ position: "absolute", top: 14, right: 14, display: "flex", gap: 8, zIndex: 3 }}>
                  <a href="https://www.instagram.com/_colocrew/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="photo-social-link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="3.5" y="3.5" width="17" height="17" rx="5" />
    ...
    <section style={{ backgroundColor: "#faf6f0", position: "relative", overflow: "hidden" }}>
      ...
      <div className="relative mx-auto grid w-full max-w-[1240px] gap-6 px-5 pb-20 pt-4 md:grid-cols-[1.05fr_0.95fr] md:px-8">
        <Reveal className="relative min-h-[520px] overflow-hidden rounded-2xl shadow-xl md:min-h-[72vh]">
          <Image src="/banqueimage/testimonials/testimonial-group-beach-01.jpg" alt={text.cta} fill className="object-cover" sizes="(max-width: 768px) 100vw, 55vw" />
      ...
      <div className="relative mx-auto -mt-6 grid w-full max-w-[1240px] gap-4 px-5 pb-12 md:grid-cols-2 md:px-8">
        <Reveal className="relative min-h-[280px] overflow-hidden rounded-2xl shadow-md">
          <Image src="/banqueimage/testimonials/testimonial-portrait-smile-01.jpg" alt="" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
        </Reveal>
        <Reveal delay={0.08} className="relative min-h-[280px] overflow-hidden rounded-2xl shadow-md md:translate-y-6">
          <Image src="/banqueimage/testimonials/testimonial-portrait-smile-02.jpg" alt="" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
        </Reveal>
      </div>
  ...
  return (
    <section style={{ backgroundColor: "#1a0d2e", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", inset: 0 }}>
        <Image
          src="/banqueimage/group/group-team-beach-01.jpg"
          alt=""
          fill
          className="object-cover"
          style={{ opacity: 0.2 }}
      ...
      <div className="relative mx-auto grid w-full max-w-[1240px] gap-6 px-5 pt-10 md:grid-cols-[0.95fr_1.05fr] md:px-8 md:pt-14">
        <Reveal className="relative min-h-[430px] overflow-hidden rounded-2xl shadow-xl md:min-h-[70vh]">
          <Image src="/banqueimage/blog/blog-food-collective-01.jpg" alt={text.socialTitle} fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
        ...
        <div className="flex flex-col gap-5">
          <Reveal className="relative min-h-[206px] overflow-hidden rounded-2xl shadow-md">
            <Image src="/banqueimage/activity/activity-surf-session-02.jpg" alt="" fill className="object-cover" sizes="50vw" />
          </Reveal>
          <Reveal delay={0.08} className="relative min-h-[206px] overflow-hidden rounded-2xl shadow-md">
            <Image src="/banqueimage/activity/activity-surf-session-03.jpg" alt="" fill className="object-cover" sizes="50vw" />
          </Reveal>
          <Reveal delay={0.14}>
