...
/* ─── CSS INJECTÉ (hover sur sous-éléments) ── */
const injectCss = `
  ...
  .hdr-top-link:hover .hdr-top-dot {
    opacity: 1;
    transform: scale(1.2);
  }
...
function MobileMenu({ isOpen, closeMenu }) {
  ...
  return (
    <div style={{ borderTop: "1px solid #eadfce", background: "#fff", padding: 16 }} className="lg:hidden">
  ...
  return (
    <>
      ...
      <header style={{ position: "fixed", inset: "0 0 auto 0", zIndex: 50, borderBottom: "1px solid #e9ddd0", background: "rgba(255,255,255,0.97)", backdropFilter: "blur(12px)" }}>
        ...
        {/* Barre principale */}
        <div style={{ position: "relative", maxWidth: 1280, margin: "0 auto", height: 80, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, padding: "0 24px" }}>

          {/* Logo */}
          <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 12 }}>
            <Image src="/LogoColoCrew.png" alt="Logo ColoCrew" width={74} height={74} style={{ height: 54, width: "auto" }} priority />
            <div className="hidden sm:block" style={{ lineHeight: 1 }}>
              <p style={{ margin: 0, fontFamily: '"Baloo 2", cursive', fontSize: 36, fontWeight: 800, color: "#2a2050", lineHeight: 1 }}>ColoCrew</p>
              <p style={{ margin: "4px 0 0", fontSize: 13, fontWeight: 700, letterSpacing: "0.25em", color: "#B8336A" }}>SAISON 2026</p>
            </div>
          </Link>

          {/* Nav desktop */}
          <nav className="hidden lg:flex flex-1 items-center pl-8 pr-6" style={{ gap: 2, flexWrap: "nowrap" }}>
            ...
            <Link href="/#journal"
              className="hdr-blog-link"
              style={{ padding: "9px 10px", fontSize: "0.86rem", fontWeight: 700, letterSpacing: "0.04em", color: "#24173d", textDecoration: "none", transition: "color 0.18s", whiteSpace: "nowrap" }}>
              BLOG
            </Link>
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <Link
                href="/sejours"
                className="flex items-center gap-1.5 text-[#B8336A] bg-[#fce8f0] border-2 border-[#B8336A] font-bold text-sm px-4 py-2 rounded-full hover:bg-[#B8336A] hover:text-white transition-colors duration-200"
                style={{ textDecoration: "none" }}
              >
                RÉSERVER
              ...
              <a
                href="tel:0184210230"
                className="hidden xl:inline-flex items-center gap-2 rounded-full border border-[#eadfce] bg-white px-3 py-2 text-sm font-semibold text-[#24173d] transition-colors duration-200 hover:border-[#B8336A] hover:text-[#B8336A]"
                style={{ textDecoration: "none" }}
              >
                <FaPhone size={12} />
                01 84 21 02 30
