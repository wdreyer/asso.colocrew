...
const NAV_STRUCTURE = [
  { label: "Vue d'ensemble", href: "/dashboard", icon: "grid", exact: true },
  {
    ...
    items: [
      ...
      { label: "Déroulés",            href: "/dashboard/deroules",     icon: "clipboard" },
...
function Icon({ type, size = 15 }) {
  ...
  switch (type) {
    ...
    case "clipboard": return <svg {...p}><rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4V2h6v2M9 9h6M9 13h6M9 17h4"/></svg>;
