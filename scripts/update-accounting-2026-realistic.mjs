...
const products2026 = [
  ...
  { label: "Autres produits, apports et tresorerie integree", account: "75", amount: 92058.07 },
...
const note2026 = "Atterrissage 2026 repris depuis l'export Qonto au 03/09/2026 et le tableau de cloture transmis. Les flux Qonto exacts representent 316 389,15 EUR d'encaissements et 301 861,15 EUR de decaissements ; le tableau ajoute 56 118,72 EUR a encaisser et 49 545,50 EUR a payer. Les remboursements de prets sont integres en regularisations de cloture et devront etre neutralises dans la lecture de bilan, sans creer de categories visibles par personne.";
...
const forecast = {
  ...
  note: "Budget 2026 repris depuis l'export Qonto complet transmis et le tableau de cloture. Les postes restent ranges dans les categories du bilan comptable ; les remboursements de prets sont integres en regularisations de cloture afin de ne pas creer de categories visibles par personne.",
};
...
const landing2026 = {
  bankMonthly: [
    ...
    { month: "Octobre", inflows: 56118.72, outflows: 49545.5, note: "Reste 2026 - tableau de cloture transmis" },
