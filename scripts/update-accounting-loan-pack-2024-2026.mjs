...
const accountingPatch = {
  ...
  financial2025: {
    ...
    expenses: [
      { label: "Alimentation des sejours", account: "6061", amount: 18774.88 },
      { label: "Fournitures, materiel, pedagogie, sante, investissements et fonctionnement", account: "6063", amount: 8280.09 },
      { label: "Carburant, entretien vehicule et peages sejours", account: "6068", amount: 3308.4 },
      { label: "Hebergement, activites et prestataires sejours", account: "613", amount: 63057.47 },
      { label: "Assurance", account: "616", amount: 81.68 },
      { label: "Multimedia, stockage, vie d'equipe et formation", account: "618", amount: 1318.02 },
      { label: "Marketing, publicite, emailing, textile et papier", account: "623", amount: 2406.76 },
      { label: "Transports collectifs, fret et bus sejours", account: "625", amount: 22834.63 },
      { label: "Deplacements du personnel", account: "6251", amount: 2175.69 },
      { label: "Repas et hebergement du personnel", account: "6256", amount: 4071.22 },
      { label: "Telephonie", account: "626", amount: 204.99 },
