...
import { FaClock, FaPaintBrush, FaRunning, FaUtensils, FaUsers,  FaHandHoldingHeart } from "react-icons/fa"; // Added icons for the new cards
      ...
      <div className="relative h-[65vh] overflow-hidden z-0 mb-2 ">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center">
          <div className="text-white space-y-8">
            <h1 className="text-5xl font-extrabold uppercase tracking-wide px-4 sm:px-6 md:px-8 md:text-8xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-center items-stretch">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between text-center h-full">
              <div>
                ...
                <p className="text-gray-600">
                  Des séjours de 12 jours  permettant la création de liens forts et d'un véritable esprit de groupe.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between text-center h-full">
              <div>
                <FaHandHoldingHeart className="text-purple-600 text-6xl mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Inclusivité</h3>
                <p className="text-gray-600">
                  Mixité sociale, respect des droits des enfants, féminisme, consentement, anti-racisme et formation contre la maltraitance pour les animateurs.ices.
                </p>
              </div>
            </div>
