    ...
    <div style="background:#fff; padding:20px;">
      ...
      <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
        <tr>
          ...
          <td style="border:1px solid #eee; padding:8px;">${transport.departureCity || "Non renseignée"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Ville de retour</td>
          <td style="border:1px solid #eee; padding:8px;">${transport.returnCity || "Non renseignée"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Frais de transport</td>
          <td style="border:1px solid #eee; padding:8px;">${transport.fee || 0} €</td>
        </tr>
      </table>
        ...
        minor && Array.isArray(minor.children) && minor.children.length
          ...
          <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
            <tr>
              ...
              <td style="border:1px solid #eee; padding:8px;">${child.firstName || "Non renseigné"}</td>
            </tr>
            <tr>
              <td style="border:1px solid #eee; padding:8px;"><strong>Nom</strong></td>
              <td style="border:1px solid #eee; padding:8px;">${child.lastName || "Non renseigné"}</td>
            </tr>
            <tr>
              <td style="border:1px solid #eee; padding:8px;"><strong>Date de naissance</strong></td>
              <td style="border:1px solid #eee; padding:8px;">${child.birthDate || "Non renseignée"}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="border:1px solid #eee; padding:8px;">${child.address || "Non renseignée"}, ${child.postalCode || ""} ${child.city || ""}</td>
            </tr>
          </table>
        `
              )
      ...
      <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
        <tr>
          ...
          <td style="border:1px solid #eee; padding:8px;">${legal.firstName || "Non renseigné"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Nom</td>
          <td style="border:1px solid #eee; padding:8px;">${legal.lastName || "Non renseigné"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Relation</td>
          <td style="border:1px solid #eee; padding:8px;">${legal.relation || "Non renseignée"} ${
            legal.relationOther ? "(" + legal.relationOther + ")" : ""
          }</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Email</td>
          <td style="border:1px solid #eee; padding:8px;">${legal.email || "Non renseigné"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Téléphone</td>
          <td style="border:1px solid #eee; padding:8px;">${legal.phone || "Non renseigné"}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Quotient familial (QF)</td>
          <td style="border:1px solid #eee; padding:8px;">${legal.qf || "Non renseigné"}</td>
        </tr>
        <tr>
          <td style="border:1px solid #eee; padding:8px;">Justificatif PDF</td>
          <td style="border:1px solid #eee; padding:8px;">
            ${
              legal.justificatifUrl
                ? `<a href="${legal.justificatifUrl}" style="color:${colorPrimary}; text-decoration:underline;" target="_blank" rel="noopener noreferrer">
      ...
      <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
        ...
        <tr>
          ...
          <td style="border:1px solid #eee; padding:8px;">${estimatedPriceString || "Non renseignée"}</td>
        </tr>
      </table>
